	...
	for(int i=0;i<nRows;i++)
		for(int j=0;j<nCols;j++)
		{
			if(mask[i][j]==0)
			{
				...
				float Weight=W[i][j];
				centerL1[sLabel]+=L1[i*nCols+j]*Weight;
				centerL2[sLabel]+=L2[i*nCols+j]*Weight;
				centera1[sLabel]+=a1[i*nCols+j]*Weight;
				centera2[sLabel]+=a2[i*nCols+j]*Weight;
				centerb1[sLabel]+=b1[i*nCols+j]*Weight;
				centerb2[sLabel]+=b2[i*nCols+j]*Weight;
				centerx1[sLabel]+=x1[i*nCols+j]*Weight;
				centerx2[sLabel]+=x2[i*nCols+j]*Weight;
				centery1[sLabel]+=y1[i*nCols+j]*Weight;
				centery2[sLabel]+=y2[i*nCols+j]*Weight;
					...
					for(int m=minX;m<=maxX;m++)
						for(int n=minY;n<=maxY;n++)
						{
							if(mask[m][n]==0&&label[m*nCols+n]==L)
							{
								...
								Weight=W[m][n];
								centerL1[sLabel]+=L1[m*nCols+n]*Weight;
								centerL2[sLabel]+=L2[m*nCols+n]*Weight;
								centera1[sLabel]+=a1[m*nCols+n]*Weight;
								centera2[sLabel]+=a2[m*nCols+n]*Weight;
								centerb1[sLabel]+=b1[m*nCols+n]*Weight;
								centerb2[sLabel]+=b2[m*nCols+n]*Weight;
								centerx1[sLabel]+=x1[m*nCols+n]*Weight;
								centerx2[sLabel]+=x2[m*nCols+n]*Weight;
								centery1[sLabel]+=y1[m*nCols+n]*Weight;
								centery2[sLabel]+=y2[m*nCols+n]*Weight;
