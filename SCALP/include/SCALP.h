...
#include"Seeds.h"
#include"DoSuperpixel_pw.h"
#include"point.h"
#include"myrgb2lab.h"
#include "countSuperpixel.h"
using namespace std;

//SCALP superpixel segmentation algorithm

void SCALP(unsigned char* R,unsigned char* G,unsigned char* B,int nRows,int nCols,int superpixelnum,float ratio,unsigned short* label,
        float * kernel, int bres_color, int bres_contour, float*contour, int pw)
{
    //Setting Parameters
    ...
    point *seedArray_p=new point[seedNum];
    ...
    Initialize1(L,a,b,L1,L2,a1,a2,b1,b2,x1,x2,y1,y2,W,nRows,nCols,StepX,StepY,colorCoefficient,distCoefficient);
    delete [] L;
    delete [] a;
    delete [] b;
    ...
    //Produce Superpixel
    DoSuperpixel(L1,L2,a1,a2,b1,b2,x1,x2,y1,y2,W,label,seedArray,newSeedNum,nRows,nCols,StepX,StepY,iterationNum,
            thresholdCoef,kernel,bres_color,bres_contour,contour,seedArray_p,pw,R,G,B);
    delete []seedArray;
